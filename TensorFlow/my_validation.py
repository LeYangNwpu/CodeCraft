...
perm = np.random.permutation(california_housing_dataframe.index)
train_end = 12000
validate_end = 17000
training_data = california_housing_dataframe.iloc[perm[:train_end]]
...
validation_data = california_housing_dataframe.iloc[perm[train_end:validate_end]]
...
def eval_model(test_examples, test_targets):
    ...
    return test_root_mean_squared_error

test_examples = process_features(california_housing_test_data)
test_targets = process_targets(california_housing_test_data)
test_root_mean_squared_error = eval_model(test_examples, test_targets)
